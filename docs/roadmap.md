...
**Status:** ✅ Complete (Items #1 and #2 shipped; Item #3 deferred to backlog)
...
| Date       | Update                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-02-14 | **Pre-M19 CLI Update UX Quick Wins complete (Items #1 & #2):** Implemented streaming progress for `cargo install` (separate _Downloading_ and _Compiling_ phases replace single "Downloading and installing" message) and automatic re-execution after CLI self-update (eliminates manual re-run requirement). Hidden `--skip-self` flag enables the new binary to continue with project dependency updates seamlessly. Added `which` crate for binary path resolution. 30 unit tests (9 new for phase detection, streaming, version parsing, project detection, summary logic), 3 integration tests. CI/CD green (`cargo xtask ci-check --full`). QA approved (0 Critical/High/Medium, 2 Low). Item #3 (dev build profile) deferred to backlog. Architecture docs updated (sdk-getting-started.md, LLD status). Feature spec ready for archival.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
