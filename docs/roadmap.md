...
3. 📝 **Architecture-doc sync follow-up (`processor-presence-hook`)**: apply Architect-identified updates in `docs/architecture/development-workflows.md`, `docs/architecture/sdk-architecture.md`, `docs/architecture/high-level-design.md`, and `docs/architecture/declarative-plugin-dsl.md` before archiving feature-spec docs
