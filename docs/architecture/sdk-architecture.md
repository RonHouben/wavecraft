...
| `wavecraft-bridge`     | IPC handler, `ParameterHost` and `SignalChainOrderAccess` traits, `PluginParamLoader` (dlopen + parameter metadata + processor metadata + dev vtable loading)                                                                                                                                 | ✅ crates.io                    | CLI uses for plugin loading                                                                                  |
...
| ----------------------- | ----------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@wavecraft/core`       | IPC bridge, React hooks, utilities, types | `useParameter`, `useAllParameters`, `useMeterFrame`, `useAudioStatus`, `useHasProcessor`, `useAvailableProcessors`, `useSignalChainOrder`, `useOscilloscopeFrame`, `IpcBridge`, `SignalChainOrderClient`, `Logger`, `ParameterId`, `ParameterIdMap`, `ProcessorId`, `ProcessorIdMap`, `AudioRuntimeStatus`, `AudioRuntimePhase`, `AudioDiagnostic`, `SignalChainOrder`, `SlotType`, types |
